 ...
 * @group Components
 */
declare class Editor extends BaseEditableHolder implements AfterContentInit, OnDestroy {
    /**
...
export type { EditorBlurEvent, EditorChangeEvent, EditorFocusEvent, EditorInitEvent, EditorSelectionChangeEvent, EditorTemplates, EditorTextChangeEvent, QuillDelta, QuillRange };
